...
- Refreshed the tested ComfyUI Core, frontend, Desktop, and official workflow-template source basis, including template coverage through `comfyui-workflow-templates` 0.11.54.
...
- The official template manifest is aligned to `comfyui-workflow-templates` 0.11.54; shipped support remains limited to the RookieUI profiles listed below.
