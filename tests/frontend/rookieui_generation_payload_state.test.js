...
} from "../../web/sidebar_tabs/rookieui_generation_payload_state.js";
...
function createTxt2ImgElements(overrides = {}) {
  return {
    ...
    templateLoraStrength: input("0.8"),
    templateLoraTriggerWord: input("muted minimalist sketch style"),
...
describe("generation payload state helpers", () => {
  ...
  test("builds txt2img payloads from DOM-like element snapshots", () => {
    ...
    expect(payload).toMatchObject({
      ...
      template_lora_enabled: false,
      template_lora_strength: 0.8,
      template_lora_trigger_word: "muted minimalist sketch style",
