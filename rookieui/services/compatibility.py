    ...
    snapshot = CompatibilityCatalogSnapshot(
        ...
        runtime_profiles=[
            ...
            CompatibilityOption(
                ...
                summary="Forge-inspired low-risk VRAM release policy for constrained hosts.",
            ),
            CompatibilityOption(
                id="async_queue",
                title="Async Queue",
                summary="Forge-inspired async swap intent without shared-memory pinning.",
            ),
            CompatibilityOption(
                id="async_shared",
                title="Async Shared",
                summary="Forge-inspired async plus shared-memory pinning hint for power users.",
                experimental=True,
            ),
        ],
        dtype_profiles=[
            ...
            CompatibilityOption(
                id="nf4",
                title="NF4",
                summary="Forge-style low-bit diffusion storage hint.",
                experimental=True,
            ),
            CompatibilityOption(
                id="fp4",
                title="FP4",
                summary="Forge-style fp4 diffusion storage hint.",
                experimental=True,
            ),
            CompatibilityOption(
                id="float8_e4m3fn",
                title="Float8 E4M3FN",
                summary="Forge-style float8-e4m3fn storage hint.",
                experimental=True,
            ...
            CompatibilityOption(
                id="float8_e5m2",
                title="Float8 E5M2",
                summary="Forge-style float8-e5m2 storage hint.",
                experimental=True,
                aliases=["float8-e5m2"],
            ),
        ],
