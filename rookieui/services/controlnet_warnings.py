...
CONTROLNET_WARNING_CONTROL_TYPE_FALLBACK_ALL = "control_type_fallback_all"
...
_WARNING_MESSAGES = {
    ...
    CONTROLNET_WARNING_CONTROL_TYPE_FALLBACK_ALL: "ControlNet control type fell back to All.",
