...
_ALL_MANIFEST_ENTRIES: tuple[FamilyTemplateManifestEntry, ...] = (
    ...
    _template_entry(
        ...
        official_template_path="comfyui-workflow-templates-json==0.1.49:image_chroma_text_to_image.json",
    ...
    _template_entry(
        ...
        official_template_path="comfyui-workflow-templates-json==0.1.49:image_krea2_turbo_t2i.json",
    ...
    _template_entry(
        ...
        official_template_path="comfyui-workflow-templates-json==0.1.49:image_flux2_klein_text_to_image.json",
        diffusion_model_hints=("klein", "4b"),
    ...
    _template_entry(
        ...
        scheduler_control_mode="flux2",
        runtime_adapter_id="klein",
        official_template_path="comfyui-workflow-templates-json==0.1.49:image_flux2_text_to_image_9b.json",
        diffusion_model_hints=("klein", "9b"),
    ...
    _template_entry(
        ...
        official_template_path="comfyui-workflow-templates-json==0.1.49:hidream_i1_dev.json",
    ...
    _template_entry(
        ...
        default_shift=3.0,
        runtime_adapter_id="hidream",
        official_template_path="comfyui-workflow-templates-json==0.1.49:hidream_i1_fast.json",
    ...
    _template_entry(
        ...
        default_shift=3.0,
        runtime_adapter_id="hidream",
        official_template_path="comfyui-workflow-templates-json==0.1.49:hidream_i1_full.json",
    ...
    _template_entry(
        ...
        official_template_path="comfyui-workflow-templates-json==0.1.49:image_longcat_text_to_image.json",
    ...
    _template_entry(
        ...
        official_template_path="comfyui-workflow-templates-json==0.1.49:image_qwen_image_edit.json",
    ...
    _template_entry(
        ...
        official_template_path="comfyui-workflow-templates-json==0.1.49:flux_kontext_dev_basic.json",
    ...
    _template_entry(
        ...
        official_template_path="comfyui-workflow-templates-json==0.1.49:image_flux2_klein_9b_kv_image_edit.json",
