...
_ALL_MANIFEST_ENTRIES: tuple[FamilyTemplateManifestEntry, ...] = (
    ...
    _template_entry(
        ...
        official_template_path="comfyui-workflow-templates-json==0.1.66:image_chroma_text_to_image.json",
    ...
    _template_entry(
        ...
        official_template_path="comfyui-workflow-templates-json==0.1.66:image_krea2_turbo_t2i.json",
    ...
    _template_entry(
        ...
        official_template_path="comfyui-workflow-templates-json==0.1.66:image_flux2_klein_text_to_image.json",
        diffusion_model_hints=("klein", "4b"),
    ...
    _template_entry(
        ...
        scheduler_control_mode="flux2",
        runtime_adapter_id="klein",
        official_template_path="comfyui-workflow-templates-json==0.1.66:image_flux2_text_to_image_9b.json",
        diffusion_model_hints=("klein", "9b"),
    ...
    _template_entry(
        ...
        official_template_path="comfyui-workflow-templates-json==0.1.66:hidream_i1_dev.json",
    ...
    _template_entry(
        ...
        default_shift=3.0,
        runtime_adapter_id="hidream",
        official_template_path="comfyui-workflow-templates-json==0.1.66:hidream_i1_fast.json",
    ...
    _template_entry(
        ...
        default_shift=3.0,
        runtime_adapter_id="hidream",
        official_template_path="comfyui-workflow-templates-json==0.1.66:hidream_i1_full.json",
    ...
    _template_entry(
        ...
        official_template_path="comfyui-workflow-templates-json==0.1.66:image_longcat_text_to_image.json",
    ...
    _template_entry(
        ...
        public_base_family="qwen_image_21",
        default_width=1024,
        default_height=1024,
        default_steps=25,
        default_cfg_scale=1.0,
        default_sampler="euler",
        default_scheduler="simple",
        compatibility_summary="Qwen-Image 2.1 candidate graph; real model execution requires host qualification.",
        aliases=("qwen-image 2.1", "qwen image 2.1"),
        notes=(
            "Requires the Qwen Image 2.1 diffusion model, Qwen3-VL 8B encoder and 2.1 VAE from the official Comfy-Org model card.",
            "Uses the Qwen Research License; review the license before use: https://github.com/QwenLM/Qwen-Image-2.1/blob/fb7ae1d1f9611cd91524d03c53c5246b36ac8577/LICENSE",
            "The new profile is not live-qualified on the accepted host yet.",
            "At default CFG 1 the negative text is encoded but does not affect sampling; raise CFG to use it.",
        ),
        runtime_adapter_id="qwen_image_21",
        official_template_path="comfyui-workflow-templates-json==0.1.66:image_qwen_image_2_1_t2i.json",
        diffusion_model_hints=("qwen_image_2.1",),
        diffusion_model_priority_hints=(("qwen_image_2.1_int8_convrot.safetensors",), ("qwen_image_2.1_bf16.safetensors",)),
        text_encoder_hints=("qwen3vl_8b",),
        text_encoder_priority_hints=(("qwen3vl_8b_int8_convrot.safetensors",), ("qwen3vl_8b_bf16.safetensors",), ("qwen3vl_8b_w4a8.safetensors",)),
        vae_hints=("qwen_image_2.1_vae_bf16.safetensors",),
        vae_priority_hints=(("qwen_image_2.1_vae_bf16.safetensors",),),
    ),
    _template_entry(
        id="qwen_image",
        ...
        diffusion_model_hints=("qwen_image_2512", "qwen-image-2512"),
    ...
    _template_entry(
        ...
        default_sampler="euler",
        default_scheduler="simple",
        compatibility_summary="Qwen-Image 2.1 candidate edit graph; live reference and alpha outcomes require host qualification.",
        aliases=("qwen-image 2.1 edit", "qwen image 2.1 edit"),
        notes=(
            "Accepts one to ten ordered references; image 1 is the edit target and determines reference-size output.",
            "Background removal is an editable instruction preset using the same model and graph.",
            "Uses the Qwen Research License: https://github.com/QwenLM/Qwen-Image-2.1/blob/fb7ae1d1f9611cd91524d03c53c5246b36ac8577/LICENSE",
            "The new edit profile is not live-qualified on the accepted host yet.",
        ),
        image_edit_profile=True,
        request_contract_surface="img2img",
        reference_input_mode="multi",
        max_direct_references=10,
        encoder_family="qwen_image_21",
        flow_kind="edit",
        available_surface_flows=("img2img",),
        runtime_adapter_id="qwen_image_21_edit",
        official_template_path="comfyui-workflow-templates-json==0.1.66:image_qwen_image_2_1_image_edit.json",
        diffusion_model_hints=("qwen_image_2.1",),
        diffusion_model_priority_hints=(("qwen_image_2.1_int8_convrot.safetensors",), ("qwen_image_2.1_bf16.safetensors",)),
        text_encoder_hints=("qwen3vl_8b",),
        text_encoder_priority_hints=(("qwen3vl_8b_int8_convrot.safetensors",), ("qwen3vl_8b_bf16.safetensors",), ("qwen3vl_8b_w4a8.safetensors",)),
    ...
    _template_entry(
        ...
        official_template_path="comfyui-workflow-templates-json==0.1.66:image_qwen_image_edit.json",
        diffusion_model_hints=("qwen_image_edit", "qwen-image-edit"),
        diffusion_model_priority_hints=(
    ...
    _template_entry(
        ...
        official_template_path="comfyui-workflow-templates-json==0.1.66:flux_kontext_dev_basic.json",
    ...
    _template_entry(
        ...
        official_template_path="comfyui-workflow-templates-json==0.1.66:image_flux2_klein_9b_kv_image_edit.json",
