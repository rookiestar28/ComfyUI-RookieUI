...
MODEL_FAMILY_REGISTRY_CONTRACT_VERSION = "f167-20260423"
...
_MANIFEST_ENTRIES: tuple[FamilyTemplateManifestEntry, ...] = (
    ...
    _template_entry(
        ...
        default_sampler="euler",
        default_scheduler="simple",
        compatibility_summary="Official ComfyUI Qwen-Image Edit multi-LoRA template preset on the dedicated edit-flow seam.",
        aliases=(
    ...
    _template_entry(
        ...
        available_surface_flows=("edit",),
        runtime_adapter_id="qwen_image_edit",
        official_template_path="reference/workflow_templates/imageEdit/Firered image edit.json",
    ...
    _template_entry(
        ...
        official_template_path="reference/workflow_templates/imageEdit/Flux.2 image edit.json",
    ...
    _template_entry(
        ...
        default_sampler="euler",
        default_scheduler="simple",
        compatibility_summary="Official ComfyUI Flux.2 Klein 9B KV image-edit template preset on the current non-SD translation seam.",
    ...
    _template_entry(
        ...
        official_template_path="reference/workflow_templates/imageEdit/Longcat image edit.json",
