  ...
  return app.registerExtension({
    ...
    async setup() {
      ...
      const bootstrapState = {
        ...
        submitTxt2ImgRequest: (payload, options) => submitRookieUITxt2Img(payload, apiFetch, options),
        submitImg2ImgRequest: (payload, options) => submitRookieUIImg2Img(payload, apiFetch, options),
        inspectPngInfoRequest: (payload, options) => inspectRookieUIPngInfo(payload, apiFetch, options),
        parsePngInfoRequest: (payload, options) => inspectRookieUIPngInfo(payload, apiFetch, options),
        submitExtrasRequest: (payload, options) => submitRookieUIExtras(payload, apiFetch, options),
