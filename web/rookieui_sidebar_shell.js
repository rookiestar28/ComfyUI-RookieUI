function appendTextElement(parent, tagName, className, text, id = "") {
...
function buildFeatureList(parent, features) {
...
function buildTabList(parent, tabs) {
  const list = document.createElement("ul");
  list.className = "rookieui-shell__list";
...
function buildParityList(parent, profiles) {
  const list = document.createElement("ul");
  list.className = "rookieui-shell__list";
...
function buildCompatibilityList(parent, entries, id, formatter) {
  const list = document.createElement("ul");
  list.className = "rookieui-shell__list";
  list.id = id;
...
function createField(parent, labelText, input) {
...
function syncBoundControls(controls) {
...
function createInlineCheckboxField(parent, labelText, input) {
  const field = document.createElement("label");
...
function preventSummaryToggleOnCheckbox(toggleInput) {
  if (!toggleInput) {
    return;
  }
...
function createHiresFixSection(parent, sectionId, hiresEnabledInput) {
...
function createTextarea(id, value = "", rows = 4, options = {}) {
...
function createSelect(id, options, selectedValue, selectOptions = {}) {
...
function bindSliderPair(numberInput, rangeInput) {
