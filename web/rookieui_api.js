    ...
    entries: [
      {
        ...
        experimental: false,
        aliases: [],
        notes: ["Primary A1111 baseline for classic Stable Diffusion checkpoints."],
      },
      {
        id: "sdxl",
        title: "Stable Diffusion XL",
        ...
        experimental: false,
        aliases: [],
        notes: ["Acts as the baseline for SDXL-derived families in RookieUI parity lanes."],
      },
      {
        id: "flux",
        title: "Flux",
        ...
        experimental: true,
        aliases: [],
        notes: ["Keeps Text Encoder selector visible for family-specific host model routing."],
      },
      {
        id: "ernie_image",
        title: "ERNIE-Image",
        ...
        compatibility_summary:
          "Experimental newer-family catalog entry for host-native ERNIE-Image support on the current diffusion-model workflow seam.",
        experimental: true,
    ...
    "/rookieui/compatibility",
    {
      ...
      newer_family_profiles: [
        ...
        },
        {
          id: "anima",
          title: "Anima",
          summary: "Experimental newer-family catalog entry routed through the current SDXL seam.",
          default: false,
          experimental: true,
          aliases: [],
        },
